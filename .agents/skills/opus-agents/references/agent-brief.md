...
session's model and reasoning effort deliberately. If a skill registry entry is stale or
unavailable, ignore it and continue with this brief and the dispatch prompt.
