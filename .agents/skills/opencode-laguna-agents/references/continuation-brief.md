# Ferrum Edge Git Forge Ops opencode continuation brief
...
any agent-dispatch skill or script, including `opencode-laguna-agents`, `grok-agents`, `sol-agents`, `luna-agents`,
`opus-agents`,
