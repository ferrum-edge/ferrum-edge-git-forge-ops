...
pub use allocator::{
    allocate_and_deliver, rotate_and_deliver, AllocateOutcome, AllocatedSlot, AllocationFailure,
};
...
pub use resolver::{
    report_secrets, resolve_secrets, slot_path, ResolveReport, ResolveResult, SlotStatus,
};
