...
pub use resolver::{
    ...
    resolve_secrets_with_options, slot_path, unresolved_placeholder_slots,
    validate_known_credential_types, ConsumerCoverage, ConsumerLedger, PluginConfigCapture,
